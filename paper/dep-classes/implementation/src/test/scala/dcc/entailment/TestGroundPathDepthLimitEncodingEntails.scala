...
import dcc.entailment.EntailmentSort.GroundPathDepthLimit
...
class TestGroundPathDepthLimitEncodingEntails extends AnyFunSuite with BeforeAndAfterEach {
  private var entailment = EntailmentFactory(GroundPathDepthLimit)(NaturalNumbers.program, 0)
  ...
  override protected def beforeEach(): Unit = {
    entailment = EntailmentFactory(GroundPathDepthLimit)(NaturalNumbers.program, 0)
  }
