...
(assert (forall ((cs-a Bool) (path-p Path) (var-x Variable)) (=> (=> cs-a (instance-of (substitute (var var-x) var-x path-p) Zero)) (=> cs-a (instance-of (substitute (var var-x) var-x path-p) Nat)))))
(assert (forall ((cs-a Bool) (path-p Path) (var-x Variable)) (=> (=> cs-a (and (instance-of (substitute (var var-x) var-x path-p) Succ) (instance-of (substitute (pth (var var-x) p) var-x path-p) Nat))) (=> cs-a (instance-of (substitute (var var-x) var-x path-p) Nat)))))
(assert (not (=> (and (instance-of (var a) Succ) (instance-of (pth (var a) p) Zero)) (instance-of (var a) Zero))))
(check-sat)
