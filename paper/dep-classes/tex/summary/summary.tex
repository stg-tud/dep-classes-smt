...
% maybe use \paragraph{SMT Solver Limitations} instead of subsection

Our first approach was to resemble the syntactic-reasoning of the sequent calculus with the encoding.
...
% TODO: point towards problems with this (heavy computational focus, many infinite ADTs)

% TODO: second approach: semantics based reasoning
%       problems: still retains one infinite ADT (path) as well as recursive computation of substitutions
% TODO: after this, solver limitations
% TODO: then depth limit approach
