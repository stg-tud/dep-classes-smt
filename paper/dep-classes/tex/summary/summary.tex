...
We can think of DCCs constructor declaration as a
refinement over a class.
...
- This can be seen like a refinement type over objects.
  - In the "language" of refinement types: $\refT{x}{\mathtt{Object}}{\ovl{a}}$.
...
- \[ \llbracket \type{x}{\ovl{a}} \rrbracket =    % TODO ↓ the entails check doesn't really make sense, but how can we transport the message of it?
       \{ o | o \in \mathsf{Object} \land \entails{o}{\ovl{a}_{\sub{x}{o}}} \} \]
