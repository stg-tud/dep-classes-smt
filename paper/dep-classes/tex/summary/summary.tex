...
% - semnatic subtyping for types
%   - $\tau_1 <: \tau_2$ iff $\llbracket\tau_1\rrbracket \subseteq \llbracket\tau_2\rrbracket$
% - e.g. $\refT{i}{\mathtt{Int}}{i>0} <: \refT{i}{\mathtt{Int}}{i \geq 0}$
% - the same is true for DCCs types
% - e.g. $\type{x}{x.f::\Nat} <: \type{x}{x.f::\Nat, x.g::Nat}$ %TODO: semantically not really?
% - e.g. $\type{x}{x.f::\Zero} <: \type{x}{x.f::\Nat}$ %TODO: if zero <: nat
