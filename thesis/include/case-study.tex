...
\\
We create a $\texttt{Plus}(0, 1)$ and call \texttt{eval}
on the new instance.
\begin{align*}
...
The path equivalence constraints only get applied
once and only for constraints of the form \pathEq{x}{p}.
The evaluation of \mIt{evl_p} would require
to find the most applicable method implementation.
This requires to solve constraint entailments
such as
\[
