...
An alternative, more realistic, goal
...
constraint entailments, depends on the size of the search space.
...
In the process to ground the quantifications
of variables and paths, we introduced
new rules to the solver.
...
What we did non consider previously,
is further restricting the context.

- context restriction though introducing additional constraints
- 
