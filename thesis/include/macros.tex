...
% DCC expressions
\newcommand{\newInstance}[3]{\ensuremath{\textbf{new } \mathit{#1}(\mathit{#2} \equiv \mathit{#3})}}
\newcommand{\newInstNoArgs}[1]{\ensuremath{\textbf{new } \mathit{#1}()}}
\newcommand{\newInst}[3]{\newInstance{#1}{#2}{#3}}
\newcommand{\objConstr}[2]{\ensuremath{\textbf{new } \mathit{#1}(\mathit{#2})}}
