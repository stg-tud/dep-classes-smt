...
\begin{align*}
MType(m, x, y) &= \{ \langle\overline{a}, \overline{b}\rangle | (m(x. \overline{a}): \type{y}{\ovl{b}}...) \in P \} \\ % TODO: ...? (also in thesis)
...
and the rules for the constraint system are specified in figure \Cref{fig:dcc-constraint-entailment}.
...
and the restrictions are specified by the well-formedness rule WF-RD in figure \Cref{fig:dcc-wf}.
...
The operational semantics is given in figure \Cref{fig:dcc-opsemantics}.
...
\begin{adjustbox}{fbox, clip=true} % TODO: make adjustbox work with figure
asdf1
\end{adjustbox}
\begin{figure}
...
Type assignment for expressions is defined in figure \Cref{fig:dcc-typeass}.
...
\\
\\
Typechecking a program is defined in figure \Cref{fig:dcc-wf}.
