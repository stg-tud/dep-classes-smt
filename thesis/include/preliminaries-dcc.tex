...
\end{align*}
% R-New
\begin{prooftree} % TODO: vertical
\AxiomC{$x \not \in dom(h)$}
\AxiomC{o = \stdobj}
\AxiomC{$\constr{C}{x}{\overline{b}} \in P$}
\AxiomC{\entails{HC(h), OC(x, o)}{\overline{b}}}
\RightLabel{R-New}
\QuaternaryInfC{$\eval{h}{\newInst{C}{\overline{f}}{\overline{x}}}{h, x \mapsto o}{x}$}
\end{prooftree}
% R-Field
\begin{prooftree}
...
\UnaryInfC{ % TODO: too long for box
  \eval
    {h} % dirty usage of pathEq
    {\textbf{new } C(\pathEq{\overline{f}}{\overline{x}}, \pathEq{f}{e}, \pathEq{\overline{f'}}{\overline{e'}})}
    {h'}
    {\textbf{new } C(\pathEq{\overline{f}}{\overline{x}}, \pathEq{f}{e}, \pathEq{\overline{f'}}{\overline{e'}})}}
\end{prooftree}
