...
\\
We replace rule C-Ident with rule C-DirectIdent. % TODO: maybe remove this from here? (just state why directident is safe)
% TODO: DirectIdent is safe, because yadda yadda...
\\
- for each proof: if closable with direct ident, then closable with combination of Perm, Weak, Ident
