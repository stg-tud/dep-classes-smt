...
\\
Since our refined rules C-Subst and C-Prog enumerate
over valid variable names and paths,
we kept only the predicate \mIt{class}
and the entailment predicates \mIt{entails} and \mIt{Entails}.
The predicate \mIt{Entails} is defined as a recusive function.
%
\begin{figure}[h]
\begin{lstlisting}[language=smtlib]
(assert (!
